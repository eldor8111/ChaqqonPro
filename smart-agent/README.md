# Smart Agent — O'rnatish va Foydalanish Qo'llanmasi

## Bu nima?

**Smart Agent** — bu har bir restoran kassasida bitta o'rnatib qo'yiladigan kichik dastur.  
U orqa fonda yashirincha ishlaydi va onlayn tizimdan kelgan chek buyruqlarini USB printerga avtomatik chiqaradi.

## O'rnatish

1. `Smart_Agent_Setup.exe` faylini ishga tushiring
2. "Install" ni bosing
3. Dastur o'rnatiladi va darhol ishga tushadi
4. Windows pastki o'ng burchagidagi **tizim tepsisida (system tray)** Smart ikonkasi paydo bo'ladi
