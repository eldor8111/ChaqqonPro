...
export async function GET(request: NextRequest) {
    try {
        ...
        const reservations = await prisma.smartReservation.findMany({
            where: {
                tenantId,
                status: "confirmed",
...
export async function POST(request: NextRequest) {
    try {
        ...
        const reservation = await prisma.smartReservation.create({
            data: {
                tenantId,
                tableId,
...
export async function PUT(request: NextRequest) {
    try {
        ...
        const reservation = await prisma.smartReservation.update({
            where: { id, tenantId },
            data: { status }
        });
